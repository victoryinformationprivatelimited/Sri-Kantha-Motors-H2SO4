...
{
    class AllowanceBasicViewModel : ViewModelBase
    {
        ...
        public AllowanceBasicViewModel()
        {
        ...
        private void Print()
        {
            ...
            string[,] parameetors = new string[7, 2] { { "@PeriodID", rpt_period_id }, { "@companyBranchid",rpt_companyBranch_id  },
            ...
            form.GetReportUsingParameetors(parameetors, "AllowanceReports", "Allowance", FilterFomula, "");
            form.Show();
        }
