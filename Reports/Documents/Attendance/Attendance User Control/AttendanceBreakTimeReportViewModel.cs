...
{
    class AttendanceBreakTimeReportViewModel:ViewModelBase
    {
        ...
        public AttendanceBreakTimeReportViewModel()
        {
        ...
        private void Print()
        {
            ...
            {
                rpt_employee_id = CurrentEmployee.emp_id .TrimStart ('0').ToString ();
            }
       
            string[,] parameetors = new string[8, 2] {{ "@startDate", getDateString(StartDate) },{ "@endDate", getDateString(EndDate) }, { "@companyBranchid",rpt_companyBranch_id  },
            ...
            form.GetReportUsingParameetors(parameetors, "Attendance", "AttendanceBreakTimeReport", FilterFomula, "");
            form.Show();
        }
