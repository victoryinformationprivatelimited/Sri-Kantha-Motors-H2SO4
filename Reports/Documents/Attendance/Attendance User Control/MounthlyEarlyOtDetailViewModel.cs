...
{
    class MounthlyEarlyOtDetailViewModel:ViewModelBase
    {
        ...
        public MounthlyEarlyOtDetailViewModel()
        {
        ...
        private void Print()
        {
            ...
            form.GetReportUsingParameetors(parameetors, "Attendance", "MonthlyEarlyOTReport", FilterFomula, "");
            form.Show();
        }
