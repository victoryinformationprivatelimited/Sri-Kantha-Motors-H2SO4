...
{
    public class MonthlyAttendanceSumarryViewModel:ViewModelBase
    {
        ...
        public MonthlyAttendanceSumarryViewModel()
        {
        ...
        private void Print()
        {
            ...
            if(Checked)
            {
                string[,] para = new string[8, 2] { { "@timePeriodID", rpt_period_id }, { "@companyBranchid",rpt_companyBranch_id  },
                 ...
                 form.GetReportUsingParameetors(para, "Attendance", "DetailReports", FilterFomula, "");
                form.Show();
            }
            else
            {
                ReportViewer form = new ReportViewer();
                form.GetReportUsingParameetors(parameetors, "Attendance", "MonthlyAttendanceSumarry", FilterFomula, "");
                form.Show();
            }
