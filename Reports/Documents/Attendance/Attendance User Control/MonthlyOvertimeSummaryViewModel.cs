...
{
    public class MonthlyOvertimeSummaryViewModel:ViewModelBase
    {
        ...
        public MonthlyOvertimeSummaryViewModel()
        {
        ...
        private void Print()
        {
            ...
            form.GetReportUsingParameetors(parameetors, "Attendance", "MonthlyOverTime", FilterFomula, "");
            form.Show();
        }
