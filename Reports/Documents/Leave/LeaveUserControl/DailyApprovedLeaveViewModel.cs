...
{
    public class DailyApprovedLeaveViewModel:ViewModelBase
    {
        ...
        public DailyApprovedLeaveViewModel()
        {
        ...
        private void Print()
        {
            ...
            form.GetReportUsingParameetors(parameetors, "Leave", "DailyApprovedLeaveReport", FilterFomula, "");
            form.Show();
        }
