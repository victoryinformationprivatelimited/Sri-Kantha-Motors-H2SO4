...
{
    public class HorisantalPayrollSumarryViewModel:ViewModelBase
    {
        ...
        public HorisantalPayrollSumarryViewModel()
        {
        ...
        private void Print()
        {
            ...
            //Reports.Documents.Attendance.EmployeeIDData DataSetSummary = new Attendance.EmployeeIDData();
            ...
            try
            {
                if (Summary != null)
                    ...
                    {
                        //Reports.Documents.Attendance.EmployeeIDData.GetEmployeeMonthlyPayrollSumarryRow AddRow = DataSetSummary.GetEmployeeMonthlyPayrollSumarry.NewGetEmployeeMonthlyPayrollSumarryRow();
                        ...
                        AddRow.catagory =int.Parse(item.catagory);
            ...
            catch (Exception)
            {
                ...
                HorisantalPayrollSumarryMag rpt = new HorisantalPayrollSumarryMag();
                rpt.SetDataSource(DataSetSummary);

            //HorisantalPayrollSumarry rpt = new HorisantalPayrollSumarry();
            //rpt.SetDataSource(DataSetSummary);
            ...
            //form.GetReportUsingParameetors(parameetors, "PayrollReport", "HorisantalPayrollSumarry", FilterFomula, "");
            //form.Show();
        }
