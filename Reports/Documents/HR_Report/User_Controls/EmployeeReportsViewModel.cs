...
{
    class EmployeeReportsViewModel : ViewModelBase
    {
        ...
        private bool _EPersonal;
        public bool EPersonal
        {
            get { return _EPersonal; }
            set { _EPersonal = value; OnPropertyChanged("EPersonal"); }
        }

        private bool _ECompany;
        public bool ECompany
        {
            get { return _ECompany; }
            set { _ECompany = value; OnPropertyChanged("ECompany"); }
        }

        private bool _ESimplePersonal;
        public bool ESimplePersonal
        {
            get { return _ESimplePersonal;}
            set { _ESimplePersonal = value; OnPropertyChanged("ESimplePersonal"); }
        }
        ...
        private void Print()
        {
            if (ECompany) 
            {
                string path = "\\Reports\\Documents\\HR_Report\\EmployeeCompanyDeatils";
                ...
                print.setParameterValue("@Branch", CurrentBranch == null ? "" : CurrentBranch.bank_branch_id.ToString());
                print.setParameterValue("@Grade", CurrentGrade == null ? "" : CurrentGrade.grade_id.ToString());
                print.setParameterValue("@Bank", "");
                ...
                print.setParameterValue("@SubDepartment", CurrentSubDepartment == null ? "" : CurrentSubDepartment.blood_id.ToString());
                print.LoadToReportViewer();
            }
            else if (EPersonal) 
            {
                string path = "\\Reports\\Documents\\HR_Report\\EmployeeDeatils";
                ReportPrint print = new ReportPrint(path);
                print.setParameterValue("@Religion", CurrentReligen == null ? "" : CurrentReligen.religen_id.ToString());
                print.setParameterValue("@Town", CurrentTown == null ? "" : CurrentTown.town_id.ToString());
                print.setParameterValue("@City", CurrentCity == null ? "" : CurrentCity.city_id.ToString());
            ...
            else if (ESimplePersonal) 
            {
                string path = "\\Reports\\Documents\\HR_Report\\EmployeeDeatilsUnilak";
                ReportPrint print = new ReportPrint(path);
                print.setParameterValue("@Religion", CurrentReligen == null ? "" : CurrentReligen.religen_id.ToString());
                print.setParameterValue("@Town", CurrentTown == null ? "" : CurrentTown.town_id.ToString());
                print.setParameterValue("@City", CurrentCity == null ? "" : CurrentCity.city_id.ToString());
