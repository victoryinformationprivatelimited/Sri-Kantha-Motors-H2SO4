...
{
    class NewReligionReportViewModel : ViewModelBase
    {
                                        
         ERPServiceClient serviceClient;

         public NewReligionReportViewModel()
        {
            serviceClient = new ERPServiceClient();
            WindowHeader = "Religion Report";
        ...
        private void Print()
        {
            string path = "\\Reports\\Documents\\HR_Report\\Religon_Report";
