...
{
    class NewDetailedInfoReportViewModel : ViewModelBase
    {
        
         ERPServiceClient serviceClient;

         public NewDetailedInfoReportViewModel()
        {
            serviceClient = new ERPServiceClient();
            WindowHeader = "Detailed Information Report";
        ...
        private void Print()
        {
            string path = "\\Reports\\Documents\\HR_Report\\Employee_Full_Details_Report";
