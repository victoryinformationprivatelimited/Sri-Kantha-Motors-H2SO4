...
{
    class NewGenderReportViewModel : ViewModelBase
    {
                
         ERPServiceClient serviceClient;

         public NewGenderReportViewModel()
        {
            serviceClient = new ERPServiceClient();
            WindowHeader = "Gender Report";
        ...
        private void Print()
        {
            string path = "\\Reports\\Documents\\HR_Report\\Gender_Report";
