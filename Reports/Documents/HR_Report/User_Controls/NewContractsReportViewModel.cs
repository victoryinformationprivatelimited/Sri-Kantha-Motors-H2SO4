...
{
    class NewContractsReportViewModel : ViewModelBase
    {
        ERPServiceClient serviceClient;

        public NewContractsReportViewModel()
        {
            serviceClient = new ERPServiceClient();
            WindowHeader = "Contracts Report";
        ...
        private void Print()
        {
            string path = "\\Reports\\Documents\\HR_Report\\Contract_details";
