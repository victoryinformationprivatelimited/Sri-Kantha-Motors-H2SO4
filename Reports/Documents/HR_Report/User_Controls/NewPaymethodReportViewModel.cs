...
{
    class NewPaymethodReportViewModel : ViewModelBase
    {
                                
         ERPServiceClient serviceClient;

         public NewPaymethodReportViewModel()
        {
            serviceClient = new ERPServiceClient();
            WindowHeader = "Payment Method Report";
        ...
        private void Print()
        {
            string path = "\\Reports\\Documents\\HR_Report\\Payment_Method_Report";
