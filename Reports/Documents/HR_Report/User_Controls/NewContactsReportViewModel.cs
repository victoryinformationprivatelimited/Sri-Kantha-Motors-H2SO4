...
{
    class NewContactsReportViewModel : ViewModelBase
    {
         ERPServiceClient serviceClient;

         public NewContactsReportViewModel()
        {
            serviceClient = new ERPServiceClient();
            WindowHeader = "Contacts Report";
        ...
        private void Print()
        {
            string path = "\\Reports\\Documents\\HR_Report\\Contact _Report";
