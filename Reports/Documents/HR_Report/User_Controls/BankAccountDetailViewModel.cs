...
{
    public class BankAccountDetailViewModel:ViewModelBase
    {
        ...
        private void Print()
        {
            ...
            string path = "\\Reports\\Documents\\HR_Report\\EmployeeBankDetail";
            ...
            //string[,] parameetors = new string[6, 2] { { "@companyBranchid",rpt_companyBranch_id}, { "@dapartmentid",rpt_department_id  },
            //                            { "@designationid", rpt_designation_id },{"@sectionid",rpt_section_id},{"@gradeid", rpt_grade_id},{"@employeeid",rpt_employee_id}};

            //ReportViewer form = new ReportViewer();
            //form.GetReportUsingParameetors(parameetors, "HR Report", "EmployeeBankDetail", FilterFomula, "");
            //form.Show();
        }
