...
{
    class NewResignationReportViewModel : ViewModelBase
    {
        
        ERPServiceClient serviceClient;

        public NewResignationReportViewModel()
        {
            serviceClient = new ERPServiceClient();
            WindowHeader = "Resignation Report";
        ...
        private void Print()
        {
            string path = "\\Reports\\Documents\\HR_Report\\Resing_Date_Report";
