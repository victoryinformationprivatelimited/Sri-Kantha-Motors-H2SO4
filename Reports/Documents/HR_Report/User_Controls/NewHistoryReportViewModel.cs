...
{
    class NewHistoryReportViewModel : ViewModelBase
    {
        ERPServiceClient serviceClient;
        List<his_Sub_Category> ListHistorySubcategory;

        public NewHistoryReportViewModel()
        {
            serviceClient = new ERPServiceClient();
            WindowHeader = "Employee History Report";
            ListHistorySubcategory = new List<his_Sub_Category>();
            HistoryVisblie = Visibility.Visible;
            Clean();
        }
        ...
        public void RefreshHistoryCategory() 
        {
            serviceClient.GetEmployeeHistoryCategoryCompleted += (s, e) => 
            {
                HistoryCategory = e.Result;
            };
            serviceClient.GetEmployeeHistoryCategoryAsync();
        }

        public void RefreshHistorySubcategory() 
        {
            serviceClient.GetEmployeeHistorySubCategoryCompleted += (s, e) => 
            {
                HistorySubcategory = e.Result;
                if (HistorySubcategory != null && HistorySubcategory.Count() > 0)
                    ListHistorySubcategory = HistorySubcategory.ToList();
            };
            serviceClient.GetEmployeeHistorySubCategoryAsync();
        }
        ...
        private void Clean()
        {
            ...
            RefreshTown();
            RefreshEmployees();
            RefreshHistoryCategory();
            RefreshHistorySubcategory();
        }
        ...
        private IEnumerable<his_Category> _HistoryCategory;
        public IEnumerable<his_Category> HistoryCategory
        {
            get { return _HistoryCategory; }
            set { _HistoryCategory = value; OnPropertyChanged("HistoryCategory"); }
        }

        private his_Category _CurrentHistoryCategory;
        public his_Category CurrentHistoryCategory
        {
            get { return _CurrentHistoryCategory; }
            set { _CurrentHistoryCategory = value; OnPropertyChanged("CurrentHistoryCategory"); if (CurrentHistoryCategory != null && ListHistorySubcategory != null && ListHistorySubcategory.Count() > 0) { HistorySubcategory = null; HistorySubcategory = ListHistorySubcategory.Where(c => c.Category_Id == CurrentHistoryCategory.Category_id); } else { HistorySubcategory = null; HistorySubcategory = ListHistorySubcategory; } }
        }

        private IEnumerable<his_Sub_Category> _HistorySubcategory;
        public IEnumerable<his_Sub_Category> HistorySubcategory
        {
            get { return _HistorySubcategory; }
            set { _HistorySubcategory = value; OnPropertyChanged("HistorySubcategory"); }
        }

        private his_Sub_Category _CurrentHistorySubcategory;
        public his_Sub_Category CurrentHistorySubcategory
        {
            get { return _CurrentHistorySubcategory; }
            set { _CurrentHistorySubcategory = value; OnPropertyChanged("CurrentHistorySubcategory");  }
        }  
        ...
        private void Print()
        {
            string path = "\\Reports\\Documents\\HR_Report\\Employee_History";
            ...
            print.setParameterValue("@CatagoryName", CurrentHistoryCategory == null ? "" : CurrentHistoryCategory.Category_name);
            print.setParameterValue("@Sub@CatagoryName", CurrentHistorySubcategory == null ? "" : CurrentHistorySubcategory.Sub_Category_name);
