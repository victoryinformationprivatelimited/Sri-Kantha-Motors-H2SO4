...
{
    class NewEmailsReportViewModel : ViewModelBase
    {
         ERPServiceClient serviceClient;

         public NewEmailsReportViewModel()
        {
            serviceClient = new ERPServiceClient();
            WindowHeader = "E-mails Report";
        ...
        private void Print()
        {
            string path = "\\Reports\\Documents\\HR_Report\\Email_Report";
