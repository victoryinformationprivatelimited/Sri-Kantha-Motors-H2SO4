...
{
    class MigrateSalaryDetailsViewModel : ViewModelBase
    {
        #region Fields
        ...
        private IEnumerable<GetPayrollDataToMigrate_Result> _SalaryDetails;

        public IEnumerable<GetPayrollDataToMigrate_Result> SalaryDetails
        {
        ...
        #region Constructor
        public MigrateSalaryDetailsViewModel()
        {
        ...
        private void Send()
        {
            ...
            {
                BusyBox.ShowBusy("Please Wait Until Data Migrate Completed...");
                SalaryDetails = serviceClient.GetEmployeeSalaryDetailsToThakralDB(CurrentPeriod.period_id).OrderBy(c => c.emp_id);
                if (SalaryDetails != null)
                {
                    SqlConnection con;
                    SqlCommand com;
