...
namespace ERP.Reports.Documents.PayrollReport.PayrollReportUserControl
{
    public class NewPaySlipViewModel : ViewModelBase
    {
        ...
        public List<z_PaymentMethod> PaymentMethodList = new List<z_PaymentMethod>();
        ...
        public IEnumerable<z_PaymentMethod> PaymentMethod
        {
            ...
            set { _PaymentMethod = value; this.OnPropertyChanged("ShiftCatagory"); }
        }
        ...
        public z_PaymentMethod CurrentPaymentMethod
        {
            ...
            set { _CurrentPaymentMethod = value; this.OnPropertyChanged("CurrentShiftCatagory"); }
        }
        ...
        private void Print()
        {
            ...
            {
                rpt_paymet_method_id = CurrentPaymentMethod.paymet_method_id.ToString();
            }
            string[,] parameetors = new string[8, 2] { { "@timePeriodID", rpt_period_id }, { "@companyBranchid",rpt_companyBranch_id  },
                                        { "@dapartmentid", rpt_department_id },{"@designationid",rpt_designation_id},{"@sectionid", rpt_section_id},{"@gradeid", rpt_grade_id},{"@employeeid",rpt_employee_id},{"@paymentMethordId",rpt_paymet_method_id}  };

            ReportViewer form = new ReportViewer();
            form.GetReportUsingParameetors(parameetors, "PayrollReport", "PayslipNewMag", FilterFomula, "");
            form.Show();
        }
