...
{
    public class UnilakPayrollSumarryViewModel:ViewModelBase
    {
        ...
        public UnilakPayrollSumarryViewModel()
        {
        ...
        private void Print()
        {
            ...
            form.GetReportUsingParameetors(parameetors, "PayrollReport", "HorisantalPayrollSumarryUnilak", FilterFomula, "");
            form.Show();
        }
