...
{
    public class EmployeeDeductionViewModel:ViewModelBase
    {
        ...
        public EmployeeDeductionViewModel()
        {
        ...
        private void Print()
        {
            ...
            form.GetReportUsingParameetors(parameetors, "PayrollReport", "EmployeeDeductionReport", FilterFomula, "");
            form.Show();
        }
