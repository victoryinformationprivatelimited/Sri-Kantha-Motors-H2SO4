...
{
    public class EmployeeFundViewModel:ViewModelBase
    {
        ...
        private void Print()
        {
            ...
            {
                rpt_variableid = CurrentCompanyVariable.company_variableID.ToString();
            }
            ...
            string[,] parameetors = new string[8, 2] { { "@timePeriodID", rpt_period_id }, { "@companyBranchid",rpt_companyBranch_id  },
                                        { "@dapartmentid", rpt_department_id },{"@designationid",rpt_designation_id},{"@sectionid", rpt_section_id},{"@gradeid", rpt_grade_id},{"@employeeid",rpt_employee_id},{"@variableid",CurrentCompanyVariable.company_variableID.ToString()} };
            
            ReportViewer form = new ReportViewer();
            form.GetReportUsingParameetors(parameetors, "PayrollReport", "EmployeeFundReport", FilterFomula, "");
            form.Show();
        }
