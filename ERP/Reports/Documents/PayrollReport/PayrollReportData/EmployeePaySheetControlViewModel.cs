...
{
    public class EmployeePaySheetControlViewModel:ViewModelBase
    {
        ...
        public EmployeePaySheetControlViewModel()
        {
        ...
        private void Print()
        {
            ...
            form.GetReportUsingParameetors(parameetors, "PayrollReport", "EmployeePaySheet", FilterFomula, "");
            form.Show();
        }
