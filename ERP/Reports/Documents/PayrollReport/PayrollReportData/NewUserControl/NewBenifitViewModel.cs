...
{
    public class NewBenifitViewModel : ViewModelBase
    {
        ...
        private void Print()
        {
            ...
            //        if (item.amount != 0)
            //        {
            //            EmployeePayrollSummaryDataSet.EmployeeBenifitDetailRow AddRow = DataSetSummary.EmployeeBenifitDetail.NewEmployeeBenifitDetailRow();
            ...
            //            DataSetSummary.EmployeeBenifitDetail.AddEmployeeBenifitDetailRow(AddRow);

            //        }
            //    }

            IEnumerable<EmployeeBenifitDetail_Result> Summary = serviceClient.GetEmployeeBenifitDetail(rpt_period_id, rpt_companyBranch_id, rpt_department_id, rpt_designation_id, rpt_section_id, rpt_grade_id, rpt_employee_id, rpt_paymet_methord_id, rpt_company_rule_id);
            if (CurrentPeriod != null && CurrentCompanyRule != null)
            {
                NewBenifitReport rpt = new NewBenifitReport();
        ...
        public void GetEmployeeCompanyRule()
        {
            ...
            {
                CompanyRule = e.Result.Where(z => z.isdelete == false && z.benifit_id != Guid.Empty);
            };
