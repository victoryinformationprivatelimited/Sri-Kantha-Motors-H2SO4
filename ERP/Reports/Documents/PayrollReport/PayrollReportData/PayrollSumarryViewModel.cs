...
{
    public class PayrollSumarryViewModel:ViewModelBase
    {
        ...
        public PayrollSumarryViewModel()
        {
        ...
        private void Print()
        {
            ...
            form.GetReportUsingParameetors(parameetors, "PayrollReport", "PayrollSumarryReport", FilterFomula, "");
            form.Show();
        }
