...
namespace ERP.Reports.Documents.Attendance.Attendance_User_Control
{
   ...
   public class NormalAttendanceViewModel:ViewModelBase
    {
       ...
       public NormalAttendanceViewModel()
       {
       ...
       private void Print()
       {
           ...
           form.GetReportUsingParameetors(parameetors, "Attendance", "NormalAttendaneReport", FilterFomula, "");
           form.Show();
       }
