...
{
    public class MonthlyDetailAttendanceViewModel:ViewModelBase
    {
        ...
        public MonthlyDetailAttendanceViewModel()
        {
        ...
        private void Print()
        {
            ...
            form.GetReportUsingParameetors(parameetors, "Attendance", "MonthlyDetailAttendaneReport", FilterFomula, "");
            form.Show();
        }
