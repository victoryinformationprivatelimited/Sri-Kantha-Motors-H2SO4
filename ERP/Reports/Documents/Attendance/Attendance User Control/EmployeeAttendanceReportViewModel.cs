...
{
    class EmployeeAttendanceReportViewModel : ViewModelBase
    {
        ...
        private void RefreshEmployees()
        {
            ...
            {
                Employees = e.Result.Where(c => c.isdelete == false).OrderBy(d => d.emp_id);
            };
        ...
        private void PrintReport()
        {
            try
            {
                string path = "\\Reports\\Documents\\Attendance\\EmployeeAttendanceReport";
