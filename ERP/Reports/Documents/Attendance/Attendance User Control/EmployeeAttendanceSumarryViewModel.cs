...
{
    public class EmployeeAttendanceSumarryViewModel:ViewModelBase
    {
        ...
        public EmployeeAttendanceSumarryViewModel()
        {
        ...
        private void Print()
        {
            ...
            form.GetReportUsingParameetors(parameetors, "Attendance", "NormalEmployeeAttendanceSummary", FilterFomula, "");
            form.Show();
        }
