...
{
    public class PermanentActiveViewModel:ViewModelBase
    {
        ...
        public PermanentActiveViewModel()
        {
        ...
        private void Print()
        {
            ...
            string path = "\\Reports\\Documents\\HR_Report\\EmployeePermanentActiveDate";
            ...
            //form.GetReportUsingParameetors(parameetors, "HR Report", "EmployeePermanentActiveDate", FilterFomula, "");
            //form.Show();
        }
