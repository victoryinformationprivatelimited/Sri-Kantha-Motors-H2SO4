...
{
    class NewServicePeriodReportViewModel : ViewModelBase
    {
        
        ERPServiceClient serviceClient;

        public NewServicePeriodReportViewModel()
        {
            serviceClient = new ERPServiceClient();
            WindowHeader = "Service Period Report";
        ...
        private void Print()
        {
            string path = "\\Reports\\Documents\\HR_Report\\Service_Period";
