...
{
    class NewCivilStatusReportViewModel : ViewModelBase
    {
        ERPServiceClient serviceClient;

        public NewCivilStatusReportViewModel()
        {
            serviceClient = new ERPServiceClient();
            WindowHeader = "Civil Status Report";
        ...
        private void Print()
        {
            string path = "\\Reports\\Documents\\HR_Report\\Civil_Status_Report";
