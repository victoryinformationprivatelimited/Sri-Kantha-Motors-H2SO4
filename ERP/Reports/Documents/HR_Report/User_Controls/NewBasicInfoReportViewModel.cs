...
{
    class NewBasicInfoReportViewModel : ViewModelBase
    {
        
         ERPServiceClient serviceClient;

         public NewBasicInfoReportViewModel()
        {
            serviceClient = new ERPServiceClient();
            WindowHeader = "Basic Infromation Report";
        ...
        private void Print()
        {
            string path = "\\Reports\\Documents\\HR_Report\\Basic_Information_Report";
