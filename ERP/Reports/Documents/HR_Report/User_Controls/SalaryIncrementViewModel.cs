...
{
    public class SalaryIncrementViewModel:ViewModelBase
    {
        ...
        public SalaryIncrementViewModel()
        {
        ...
        public bool DetailReport
        {
            ...
            set { _DetailReport = value; this.OnPropertyChanged("DetailReport");
        ...
        private bool _SumarryReport;
        public bool SumarryReport
        {
            get { return _SumarryReport; }
            set { _SumarryReport = value; this.OnPropertyChanged("SumarryReport");
            if (SumarryReport == true)
            {
                DetailReport = false;
            }
            }
        ...
        private void Print()
        {
           ...
           // string rpt_shift_id = "";
            ...
            if (DetailReport == true)
            {
                ...
                string path = "\\Reports\\Documents\\PayrollReport\\BasicSalaryIncrement";
                ReportPrint print = new ReportPrint(path);
                print.setParameterValue("@employeeid", rpt_employee_id);
                print.setParameterValue("@dapartmentid", rpt_department_id);
                print.setParameterValue("@sectionid", rpt_section_id);
                print.setParameterValue("@designationid", rpt_designation_id);
                print.setParameterValue("@companyBranchid", rpt_companyBranch_id);
                print.setParameterValue("@gradeid", rpt_grade_id);
                print.LoadToReportViewer();

            }
            else
            {
                string path = "\\Reports\\Documents\\PayrollReport\\BasicSalaryIncrementDetail";
                ReportPrint print = new ReportPrint(path);
                print.setParameterValue("@employeeid", rpt_employee_id);
                print.setParameterValue("@dapartmentid", rpt_department_id);
                print.setParameterValue("@sectionid", rpt_section_id);
