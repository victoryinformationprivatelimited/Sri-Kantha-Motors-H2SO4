...
{
    class EmployeeBasicSalaryViewModel:ViewModelBase
    {
        ...
        public EmployeeBasicSalaryViewModel()
        {
        ...
        private void Print()
        {
            ...
            string path = "\\Reports\\Documents\\HR_Report\\EmployeeBasicSalary";
            ...
            //form.GetReportUsingParameetors(parameetors, "HR Report", "EmployeeBasicSalary", FilterFomula, "");
            //form.Show();
        }
