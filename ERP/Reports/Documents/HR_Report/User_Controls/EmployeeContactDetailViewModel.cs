...
{
    class EmployeeContactDetailViewModel:ViewModelBase
    {
        ...
        public EmployeeContactDetailViewModel()
        {
        ...
        private void Print()
        {
            ...
            string path = "\\Reports\\Documents\\HR_Report\\EmployeeContactsSummaryReport";
            ...
            //form.GetReportUsingParameetors(parameetors, "HR Report", "EmployeeContactsSummaryReport", FilterFomula, "");
            //form.Show();
        }
