...
{
    class NewAddressReportViewModel : ViewModelBase
    {
        ERPServiceClient serviceClient;

        public NewAddressReportViewModel()
        {
            serviceClient = new ERPServiceClient();
            WindowHeader = "Address Report";
        ...
        private void Print()
        {
            string path = "\\Reports\\Documents\\HR_Report\\Address_Report";
