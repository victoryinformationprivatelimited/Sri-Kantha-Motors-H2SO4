...
{
    public class AttendanceRuleData
    {
        #region Fixed Data Migrate Rules

        public static List<z_Datamigration_Configuration> FIXED_DATA_MIGRATE_RULES = new List<z_Datamigration_Configuration>();

        public static List<dtl_AttendanceBonus> ATTENDANCE_BONUS_RULES = new List<dtl_AttendanceBonus>();
        ...
        public static Guid GetAttendanceRule(AttendanceRuleName name)
        {
            switch (name)
            {
                ...
                case AttendanceRuleName.POYA_OT_SHOP_AND_OFFICE:
                    return new Guid("10000000-0000-0000-0001-000000000001");
                case AttendanceRuleName.POYA_OT_WAGES_BOARD:
                    return new Guid("10000000-0000-0000-0001-000000000002");
                case AttendanceRuleName.SHORT_LEAVE_SHOP_AND_OFFICE:
                    return new Guid("22000000-0000-0000-0000-000000000001");
                case AttendanceRuleName.SHORT_LEAVE_WAGES_BOARD:
                    return new Guid("22000000-0000-0000-0000-000000000002");

                case AttendanceRuleName.GRACE_LATE_SHOP_AND_OFFICE:
                    return new Guid("30000000-0000-0000-0000-000000000001");
                case AttendanceRuleName.GRACE_LATE_WAGES_BOARD:
                    return new Guid("30000000-0000-0000-0000-000000000002");
                ...
                //case AttendanceRuleName.ProformanceBonus0point5Deductvalue:
                //    return new Guid("00000000-0000-0000-0000-000000000003");
                //case AttendanceRuleName.ProformanceBonus1point0Deductvalue:
                //    return new Guid("00000000-0000-0000-0000-000000000003");
                //case AttendanceRuleName.ProformanceBonus1point5Deductvalue:
                //    return new Guid("00000000-0000-0000-0000-000000000003");
                //case AttendanceRuleName.ProformanceBonus2point0Deductvalue:
                //    return new Guid("00000000-0000-0000-0000-000000000003");
                //case AttendanceRuleName.ProformanceBonus2point5Deductvalue:
                //    return new Guid("00000000-0000-0000-0000-000000000003");
                //case AttendanceRuleName.ProformanceBonus3point0Deductvalue:
                //    return new Guid("00000000-0000-0000-0000-000000000003");


                //case AttendanceRuleName.proformance15Deduction:
                //    return new Guid("00000000-0000-0000-0000-000000000003");
                //case AttendanceRuleName.proformance25Deduction:
                //    return new Guid("00000000-0000-0000-0000-000000000003");
                //case AttendanceRuleName.proformance35Deduction:
                //    return new Guid("00000000-0000-0000-0000-000000000003");

                //case AttendanceRuleName.NopayWages:
                //    return new Guid("00000000-0000-0000-0000-000000000003");
                //case AttendanceRuleName.NopayShopAndOffice:
                //    return new Guid("10000000-0000-0000-0000-000000000002");

                //case AttendanceRuleName.attendanceBonusDeduction1:
                //    return new Guid("44bba522-c4a8-4b2f-b137-8e1daefce7e4");
                //case AttendanceRuleName.attendanceBonusDeduction2:
                //    return new Guid("3fb66a8e-60d1-46a8-9e84-adb6971cde6c");
                //case AttendanceRuleName.attendanceBonusDeduction3:
                //    return new Guid("2906621b-c8bf-4c35-ae3b-70212b08d580");
                //case AttendanceRuleName.attendanceBonusDeduction4:
                //    return new Guid("b9d14fab-fa76-4349-8f04-539124d1b269");
    ...
    public enum AttendanceRuleName
    {
        ...
        // for Mahogany Master Pieces ===============
        POYA_OT_SHOP_AND_OFFICE,
        POYA_OT_WAGES_BOARD,
        SHORT_LEAVE_SHOP_AND_OFFICE,
        SHORT_LEAVE_WAGES_BOARD,
        ...
        AttendanceBonus,
        ProformanceBonus0point5Deductvalue,
        ProformanceBonus1point0Deductvalue,
        ProformanceBonus1point5Deductvalue,
        ProformanceBonus2point0Deductvalue,
        ProformanceBonus2point5Deductvalue,
        ProformanceBonus3point0Deductvalue,

        proformance15Deduction,
        proformance25Deduction,
        proformance35Deduction,
        ProformanceBonus,
        ...
        //MCN =======================================
        GRACE_LATE_SHOP_AND_OFFICE,
        GRACE_LATE_WAGES_BOARD
        // ==========================================
